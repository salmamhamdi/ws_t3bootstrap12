...
namespace WapplerSystems\WsT3bootstrap\ViewHelpers\IndexedSearch;
...
class PageBrowsingViewHelper extends AbstractTagBasedViewHelper
{
    ...
    public function render()
    {
        ...
        if ($currentPage > 0) {
            ...
            $content .= '<li class="page-item">' . $this->makecurrentPageSelector_link($label, $currentPage - 1, $freeIndexUid) . '</li>';
        }
        ...
        for ($a = $minPage; $a <= $maxPage; $a++) {
            ...
            if ($a === $currentPage) {
                $content .= '<li class="page-item active" aria-current="page"><strong>' . $label . '</strong></li>';
            } else {
