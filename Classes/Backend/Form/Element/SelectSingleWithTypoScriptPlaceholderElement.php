...
class SelectSingleWithTypoScriptPlaceholderElement extends AbstractFormElement
{
    ...
    public function render()
    {
        ...
        $classList = ['form-select', 'form-control', 'form-control-adapt'];
        ...
        $defaultValue = ContentElementSettings::getSettingByTypeAndPath($this->data['databaseRow']['CType'][0], $config['typoscriptPath'], $typoscript);
